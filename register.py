...
class Register:
    def __init__(self, root ): # default constructor and root is a tkinter class object
        ...
        self.root.geometry("1460x655+0+0") # Setting width
        ...
        btn_login=Button(self.root,text="Sign In",fg="white",background="green",font=("times new roman",17),bd=0,cursor="hand2", command=self.login_window).place(x=800, y=503,width=120,height=33)
